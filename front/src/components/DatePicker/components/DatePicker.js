...
export default class DatePicker extends Component {
  ...
  getInputFormat(isGregorian, timePicker) {
    if (timePicker)
      return isGregorian ? "YYYY/MM/DD hh:mm A" : "jYYYY/jM/jD hh:mm A";
    return isGregorian ? "YYYY/MM/DD" : "jYYYY/jM/jD";
  }
  ...
  getValue(inputValue, isGregorian, timePicker) {
    ...
    if (!inputFormat)
      inputFormat = this.getInputFormat(isGregorian, timePicker);
  ...
  handleInputChange(event) {
    ...
    if (momentValue.isValid() && inputValue) {
    ...
    if (!momentValue.isValid() || (!inputValue && this.props.onChange)) {
  ...
  hanldeBlur(event) {
    if (this.props.onChange) {
      ...
      if (this.props.setDirtyChildren) this.props.setDirtyChildren();
    ...
    return (
      <div ref={ref}>
        <input
          ...
          value={
            isGregorian || !this.props.persianDigits
              ? inputValue
              : this.toPersianDigits(inputValue)
          }
    ...
    return (
      <div ref={ref}>
        <Calendar
          ...
          isGregorian={isGregorian}
          calendarClass={
            this.props.calendarClass ? this.props.calendarClass : ""
          }
