...
class DialogReportDesigner extends BaseComponent {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
    ...
    SystemClass.DialogReportDesignerContainer = this;
  ...
  _setReport2 = () => {
    ...
    const designerDataSource = JSON.parse(JSON.stringify({})).map((row) => {
    ...
    dataSet.readJson(designerDataSource);
